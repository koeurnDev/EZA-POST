        ...
        <DashboardLayout>
            ...
            <div className="max-w-5xl mx-auto px-6 py-12 relative z-10">
                        ...
                        <div className="p-8 border-b border-white/10 dark:border-white/5 flex items-center justify-between">
                            <div>
                                <h3 className="text-xl font-black text-gray-900 dark:text-white tracking-tight flex items-center gap-3">
                                    Your Facebook Pages
                                    <span className="px-3 py-1 bg-emerald-500/10 text-emerald-500 text-[10px] rounded-full font-black tracking-widest uppercase">
                                        {pages.length} Online
                                    </span>
                                </h3>
                            </div>
                            <button 
                                ...
                                className="w-10 h-10 rounded-xl bg-white/5 hover:bg-white/10 flex items-center justify-center text-gray-400 hover:text-emerald-500 transition-all border border-white/10 shadow-inner"
                            >
                                <RefreshCw size={18} className={isLoadingPages ? "animate-spin text-emerald-500" : ""} />
                            </button>
                        </div>
                                                ...
                                                >
                                                    <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
                                                        {[
                                                            ...
                                                            <div key={setting.key} className="bg-white/40 dark:bg-white/5 p-6 rounded-[1.8rem] border border-white/10 dark:border-white/5 shadow-sm flex flex-col justify-between gap-6 hover:border-emerald-500/30 transition-all group/setting">
                                                                <div>
                ...
                <MotionDiv
                    ...
                    className="mt-12 p-8 bg-gradient-to-br from-emerald-500/5 to-teal-500/5 backdrop-blur-2xl rounded-[3rem] border border-emerald-500/20 shadow-2xl overflow-hidden relative group"
                >
                    ...
                    <div className="flex flex-col md:flex-row items-center gap-10 relative z-10">
                        <div className="w-20 h-20 bg-emerald-500/10 rounded-[1.8rem] flex items-center justify-center text-emerald-500 border border-emerald-500/20 shadow-inner">
                            <ShieldCheck size={40} />
                        </div>
                        <div className="flex-1 text-center md:text-left">
                            <div className="flex items-center justify-center md:justify-start gap-3 mb-3">
                                <div className="w-2 h-2 bg-emerald-500 rounded-full animate-ping" />
                                <span className="text-[10px] font-black text-emerald-500 uppercase tracking-[0.3em]">ប្រព័ន្ធការពារកម្រិតខ្ពស់</span>
                            </div>
                            <h3 className="text-2xl font-black text-gray-900 dark:text-white tracking-tight mb-2">ការតភ្ជាប់ប្រកបដោយសុវត្ថិភាព</h3>
                            <p className="text-gray-500 dark:text-gray-400 font-medium leading-relaxed max-w-3xl text-sm">
                        ...
                        <div className="flex gap-4">
                            <div className="w-12 h-12 bg-white/50 dark:bg-black/20 rounded-xl flex items-center justify-center text-gray-400 border border-white/20">
                                <Lock size={20} />
                            </div>
                            <div className="w-12 h-12 bg-white/50 dark:bg-black/20 rounded-xl flex items-center justify-center text-gray-400 border border-white/20">
                                <Globe size={20} />
