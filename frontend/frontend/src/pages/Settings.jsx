...
export default function Settings() {
    ...
    const handleUpdateSetting = async (pageId, settingKey, newValue) => {
        ...
        // Don't show loading toast for small toggles to keep it snappy, 
        // or show a very subtle one. For now, let's just show success/error.
        // Actually, user wants "Instant Refresh" and "Success Feedback".
        // Let's show a success toast.
