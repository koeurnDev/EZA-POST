        ...
        <DashboardLayout>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
                ...
                <div className="lg:col-span-2 space-y-6">
                    ...
                    {/* 📘 Facebook Integration (Professional UI) */}
                    <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-sm border border-gray-100 dark:border-gray-700 overflow-hidden">
                        <div className="p-6 border-b border-gray-100 dark:border-gray-700 flex items-center justify-between">
                            <h3 className="text-lg font-semibold text-gray-900 dark:text-white flex items-center gap-2">
                                <div className="w-8 h-8 bg-[#1877f2] text-white rounded-lg flex items-center justify-center text-lg font-bold shadow-sm">f</div>
                                    ...
                                    <button
                                        onClick={async () => {
                                            if (window.confirm("Are you sure you want to disconnect your Facebook account?")) {
                                                try {
                                                    await apiUtils.disconnectFacebook();
                                        ...
                                        className="px-3 py-1.5 text-xs font-medium text-red-600 border border-red-200 hover:bg-red-50 dark:border-red-900/30 dark:text-red-400 dark:hover:bg-red-900/20 rounded-lg transition-all"
                                    >
                                        Disconnect
                                    </button>
                                </div>
                                    ...
                                    <div>
                                        ...
                                        {isLoadingPages ? (
                                            ...
                                            <div className="text-center py-8 bg-gray-50 dark:bg-gray-900/50 rounded-xl border border-dashed border-gray-200 dark:border-gray-700">
                                                ...
                                                <button onClick={handleReRequest} className="text-blue-600 text-xs font-medium hover:underline mt-1">
                                                    Check permissions
                                                </button>
                                            </div>
                                        ) : (
