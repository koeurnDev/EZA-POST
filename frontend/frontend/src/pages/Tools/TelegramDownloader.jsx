    ...
    return (
        <DashboardLayout>
            <div className="max-w-4xl mx-auto px-4 py-4 md:py-8">
                ...
                {/* 🎥 Result */}
                {result && (
                    <div className="bg-white dark:bg-gray-800 rounded-3xl p-6 md:p-8 shadow-2xl border border-gray-100 dark:border-gray-700 max-w-2xl mx-auto animate-in zoom-in duration-300">
